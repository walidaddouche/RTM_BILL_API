...
setup(
    ...
    version='1.1.1',  # Numéro de version de votre librairie
    ...
    description='A RTM Bill mailer',  # Description de votre librairie
    install_requires=['requests', 'rtm-client'],  # Liste des dépendances de votre librairie
)
